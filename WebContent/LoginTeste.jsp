    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Ir para o início da página" data-placement="bottom" href="index.jsp" target="_blank">
              <i class="fa fa-home"></i>Início
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Cadastre uma nova Olimpíada" data-placement="bottom" href="CriarOlimpiada.jsp" target="_blank">
            ...
            <div class="card-body">
                  <form class="form" method="" action="">
                    ...
                    <div class="form-group">
                      ...
                      <span class="bmd-help"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Informar um email válido, por exemplo: exemplo@exemplo.com</span>
