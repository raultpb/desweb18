...
<body class="index-page sidebar-collapse">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Ir para o início da página"  href="index.jsp" >
              <i class="fa fa-home"></i>Início
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Cadastre uma nova Olimpíada" href="CriarOlimpiada.jsp">
  ...
  <div class="main main-raised">
    <div class="section section-basic">
      <div class="container">
        <div class="title">
          <h2>Alterar Olimpíada (ID - ${olimpiada.id})</h2>
        </div>
        <!--  buttons -->
                        ...
                        <div class="row">
                         ...
                         <div class="row">
	                        ...
	                        <div id="actions" class="row">
	                            <div class="col-md-12">
	                                <button type="submit" class="btn btn-primary btn-round"  name="command" value="AlterarOlimpiada">Salvar</button>
	                                <a href="ListarOlimpiada.jsp" class="btn btn-default btn-round">Cancelar</a>
	                            </div>
	                        </div>
                        </div>
                    </form>
